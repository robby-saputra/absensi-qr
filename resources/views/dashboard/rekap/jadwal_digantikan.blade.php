...
<body>
    ...
    <main id="content" class="content" data-print-title="Rekap Jadwal Digantikan"
        ...
        <div class="rekap-head">
            ...
            <div>
                ...
                <button type="button" class="btn"
                    onclick="exportTableToExcel('rekap-jadwal-digantikan', 'Rekap Jadwal Digantikan')">Excel</button>
                <a class="btn" target="_blank"
                    href="/dashboard/admin/rekap/jadwal-digantikan-pdf?hari={{ $hari }}&alasan={{ $alasan }}">PDF
                    Resmi</a>
            </div>
        </div>
        ...
        <form method="GET" class="rekap-filter">
            ...
            <select name="alasan">
                ...
                @foreach (['izin', 'sakit', 'inval'] as $a)
                    <option value="{{ $a }}" {{ ($alasan ?? '') == $a ? 'selected' : '' }}>
                        {{ ucfirst($a) }}</option>
                @endforeach
            </select>
