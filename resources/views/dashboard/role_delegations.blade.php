...
<main id="content" class="content">
    <div class="rekap-head">
        <div><h1>Delegasi Sementara</h1><p>Catat guru pengganti sementara saat berhalangan.</p></div>
    ...
    <form method="POST" class="rekap-filter">
        ...
        <label>Mulai <input type="date" name="tanggal_mulai" value="{{ now()->toDateString() }}" required></label>
        <label>Selesai <input type="date" name="tanggal_selesai" value="{{ now()->toDateString() }}" required></label>
        <label>Alasan <textarea name="alasan" rows="3" placeholder="Alasan delegasi"></textarea></label>
        <button class="btn">Simpan Delegasi</button>
    </form>
    <div class="table-wrap">
        <table>
            <tr><th>Pengganti</th><th>Konteks</th><th>Periode</th><th>Alasan</th><th>Status</th></tr>
            ...
            @empty
                <tr><td colspan="5">Belum ada delegasi.</td></tr>
            @endforelse
        </table>
    </div>
</main>
