{{-- File ini menampilkan detail absensi mata pelajaran agar admin bisa melihat data kehadiran siswa pada pelajaran tertentu. --}}
<!DOCTYPE html>
<html lang="id">
    ...
    <main id="content" class="content">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ $absensi->guru_pelaksana ?? $absensi->guru_utama ?? '-' }}</td>
            </tr>
            <tr>
                <th>Jadwal</th>
