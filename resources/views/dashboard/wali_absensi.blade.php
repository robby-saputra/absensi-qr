        ...
        <div class="table-box">
            <form method="GET" class="filter-box">
                ...
                <label>Bulan <input type="number" name="bulan" min="1" max="12"
                        value="{{ $bulan }}"></label>
                <label>Tahun <input type="number" name="tahun" min="2020" max="2100"
                        value="{{ $tahun }}"></label>
                <label>Status
                    <select name="status">
            ...
            <div class="cards">
                <div class="card">
                    <h3>Hadir</h3>
                    <p>{{ $ringkasan['hadir'] ?? 0 }}</p>
                </div>
                <div class="card">
                    <h3>Telat</h3>
                    <p>{{ $ringkasan['telat'] ?? 0 }}</p>
                </div>
                <div class="card">
                    <h3>Izin</h3>
                    <p>{{ $ringkasan['izin'] ?? 0 }}</p>
                </div>
                <div class="card">
                    <h3>Sakit</h3>
                    <p>{{ $ringkasan['sakit'] ?? 0 }}</p>
                </div>
                <div class="card">
                    <h3>Alfa</h3>
                    <p>{{ $ringkasan['alfa'] ?? 0 }}</p>
                </div>
            </div>
            ...
            <table>
                ...
                @empty
                    <tr>
                        <td colspan="3">Tidak ada siswa rawan pada periode ini.</td>
                    </tr>
                @endforelse
            </table>
