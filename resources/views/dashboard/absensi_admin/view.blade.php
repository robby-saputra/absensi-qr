...
<main id="content" class="content">
    ...
    <table>
        <tr><th>Nama</th><td>{{ $absensi->nama_siswa }}</td></tr>
        <tr><th>NIS</th><td>{{ $absensi->nis ?? '-' }}</td></tr>
        <tr><th>Kelas</th><td>{{ $absensi->nama_kelas ?? '-' }}</td></tr>
        <tr><th>Jurusan</th><td>{{ $absensi->nama_jurusan ?? '-' }}</td></tr>
        ...
        <tr><th>Status Masuk</th><td><span class="status-pill">{{ $absensi->status_masuk ?? '-' }}</span></td></tr>
        <tr><th>Jam Pulang</th><td>{{ $absensi->jam_pulang ?? '-' }}</td></tr>
        <tr><th>Status Pulang</th><td><span class="status-pill">{{ $absensi->status_pulang ?? '-' }}</span></td></tr>
    </table>
</main>
</body>
</html>
