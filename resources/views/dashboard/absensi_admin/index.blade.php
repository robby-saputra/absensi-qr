...
<main id="content" class="content">
    ...
    <form method="GET" class="rekap-filter">
        ...
        <input type="text" name="search" value="{{ $filters['search'] ?? '' }}" placeholder="Cari nama atau NIS">
        ...
        @forelse($data as $row)
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger confirm-delete" href="/dashboard/admin/absensi/delete/{{ $row->id }}">Hapus</a>
                </td>
            </tr>
        @empty
            <tr><td colspan="9" class="empty-row">Data absensi harian belum tersedia.</td></tr>
        @endforelse
    </table>
