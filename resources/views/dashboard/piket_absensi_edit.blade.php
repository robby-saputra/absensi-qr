...
<main id="content" class="content">
    <section class="card">
        ...
        <form method="POST" action="/dashboard/piket/absensi/{{ $siswa->id }}/update" class="filter-box">
            ...
            <label>Jam Masuk <input type="time" name="jam_masuk" value="{{ old('jam_masuk', $absensi ? substr((string) $absensi->jam_masuk, 0, 5) : '') }}"></label>
            <label>Status Masuk
            ...
            <label>Jam Pulang <input type="time" name="jam_pulang" value="{{ old('jam_pulang', $absensi ? substr((string) $absensi->jam_pulang, 0, 5) : '') }}"></label>
            <label>Status Pulang
