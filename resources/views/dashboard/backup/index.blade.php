...
<body>
    ...
    <main id="content" class="content">
        ...
        <div class="info-box" style="margin-bottom:16px">
            JSON dipakai untuk restore internal sistem. SQL bisa dipakai untuk arsip manual/phpMyAdmin dan juga bisa
            direstore dari halaman ini.
        </div>
        ...
        <table>
            ...
            @forelse($backups as $backup)
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="/dashboard/admin/backup/restore/{{ $backup->name }}"
                            class="inline confirm-restore" style="display:inline">
                            @csrf
            ...
            @empty
                <tr>
                    <td colspan="5" class="empty-row">Belum ada file backup.</td>
                </tr>
            @endforelse
        </table>
    </main>
