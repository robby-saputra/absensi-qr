...
<main id="content" class="content">
    <div class="rekap-head">
        <div><h1>Pesan Internal</h1><p>Kirim catatan ringan antar guru/piket/wali terkait siswa tertentu.</p></div>
    ...
    <form method="POST" class="rekap-filter">
        ...
        <label>Pesan <textarea name="pesan" rows="3" required placeholder="Tulis pesan singkat"></textarea></label>
        <button class="btn">Kirim Pesan</button>
    </form>
    <div class="table-wrap">
        <table>
            <tr><th>Waktu</th><th>Pengirim</th><th>Siswa</th><th>Judul</th><th>Pesan</th></tr>
            @forelse($inbox as $m)
                <tr>
