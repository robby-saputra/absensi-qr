...
|--------------------------------------------------------------------------
*/
Route::get('/dashboard/admin/guru-piket', [GuruPiketController::class, 'index'])->middleware('webrole:admin');
...
|--------------------------------------------------------------------------
*/
Route::get('/dashboard/admin/guru-piket/create', [GuruPiketController::class, 'create'])->middleware('webrole:admin');

Route::get('/dashboard/admin/guru-piket/edit/{id}', [GuruPiketController::class, 'edit'])->middleware('webrole:admin');
...
|--------------------------------------------------------------------------
*/
Route::post('/dashboard/admin/guru-piket/store', [GuruPiketController::class, 'store'])->middleware('webrole:admin');

Route::post('/dashboard/admin/guru-piket/update/{id}', [GuruPiketController::class, 'update'])->middleware('webrole:admin');
...
|--------------------------------------------------------------------------
*/
Route::get('/dashboard/admin/guru-piket/delete/{id}', [GuruPiketController::class, 'delete'])->middleware('webrole:admin');
/*
|--------------------------------------------------------------------------
| LIST JURUSAN
|--------------------------------------------------------------------------
