...
// Migration ini menghubungkan QR harian dengan guru piket aktif atau pengganti aktif.
return new class extends Migration
{
    public function up(): void
    {
        // Field tambahan menyimpan jadwal piket, guru aktif, replacement, dan status aktif QR.
    ...
    {
        // Rollback menghapus field penghubung QR dengan penugasan piket aktif.
        Schema::table('qr_codes', function (Blueprint $table) {
